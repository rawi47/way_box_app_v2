...
class Env(models.Model):
	...
	api_host = models.CharField(max_length=200, default="")
	...
	portal_url = models.CharField(max_length=200, default="")
	config_dir = models.CharField(max_length=200, default="opt/config/")
	origin_config_dir = models.CharField(max_length=200, default="")
